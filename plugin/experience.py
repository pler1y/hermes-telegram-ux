...
PROGRESS_SCHEMA = {
    ...
    "parameters": {"type": "object", "properties": {
        "activity": {"type": "string", "maxLength": 160, "description": "Short plain Chinese sentence describing the actual current step or how newly read user input changes it."},
