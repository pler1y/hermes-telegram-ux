...
## 2.0.0 — release candidate, not yet tagged or released
...
- The former Catalog-safe implementation is prepared to become mainline; main is not merged yet.
...
- Verified Hermes baseline:0.21.3,`3c3ab69abb9b08683b5eb15b4e2b8be1198c875f`. See [migration](docs/MIGRATION-v2.md), [ID audit](docs/PLUGIN-ID.md) and [candidate validation](docs/VALIDATION-v2.md).
...
Earlier validation records retain their original versions and results in [VALIDATION.md](docs/VALIDATION.md).
